    ...
    <aside
      ...
      <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="tableMotor.php">
              <div
                class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-4">
        ...
        <div class="row mt-4">
          <div class="container-fluid py-4">
            <div class="row">
              <div col-12>
                <a href="Motor/tambah.php" class="btn btn-success">Tambah</a>
                <a href="Motor/laporan.php" class="btn btn-info">Laporan</a>
              </div>
              <div class="col-12">
                <div class="card mb-4">
                  ...
                  <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                      <table class="table align-items-center mb-0">
                        <thead>
                          <tr>
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Motorcycle ID
                            </th>
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Brand
                            </th>
                        ...
                        <tbody>
                          ...
                          while ($data = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="align-middle text-center" role="group">
                                  <a href="Motor/hapus.php?id=<?php echo $data['MotorcycleID']; ?>"
                                    class="btn btn-danger">Hapus</a>
                                  <a href="Motor/edit.php?id=<?php echo $data['MotorcycleID']; ?>"
                      ...
                      <script type="text/javascript">
                        alert("PESERTA TIDAK DAPAT MELIHAT DATA INI!!");
