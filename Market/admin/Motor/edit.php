...
<body>
  ...
  include("../../connect.php");
  $id = $_GET['id'];
  $cari = mysqli_query($conn, "select * from motorcycles where MotorcycleID ='$id'");
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <input type="hidden" name="code" value="<?php echo $data['MotorcycleID']; ?>">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tahun" value="<?php echo $data['YEAR']; ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="harga" class="form-control-label">Harga</label>
                    <input type="text" class="form-control" name="harga" value="<?php echo $data['Price']; ?>">
                  </div>
                </div>
                <div class="col-md-12">
