      ...
      <div class="container-fluid py-4">
        ...
        <div class="row mt-4">
          <div class="container-fluid py-4">
            <div class="row">
              <div col-12>
                <a href="User/tambah.php" class="btn btn-success">Tambah</a>
                <a href="User/laporan.php" class="btn btn-info">Laporan</a>
              </div>
              <div class="col-12">
                <div class="card mb-4">
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="align-middle text-center" role="group">
                                  <a href="User/hapus.php?id=<?php echo $data['UserID']; ?>"
                                    class="btn btn-danger">Hapus</a>
                                  <a href="User/edit.php?id=<?php echo $data['UserID']; ?>"
