    ...
    <aside
      ...
      <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="tableRiwayat.php">
              <div
                class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-4">
        ...
        <div class="row mt-4">
          <div class="container-fluid py-4">
            <div class="row">
              <div col-12>
                <a href="Riwayat/laporan.php" class="btn btn-info">Laporan</a>
              </div>
              <div class="col-12">
                <div class="card mb-4">
                  <div class="card-header pb-0">
                    <h6>Data Riwayat Pembeli</h6>
                  </div>
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="align-middle text-center" role="group">
                                  <a href="Riwayat/hapus.php?id=<?php echo $data['TransactionID']; ?>"
                                    class="btn btn-danger">Hapus</a>
                                  <a href="Riwayat/edit.php?id=<?php echo $data['TransactionID']; ?>"
